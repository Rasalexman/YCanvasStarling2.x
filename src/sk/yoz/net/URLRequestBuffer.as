package sk.yoz.net
{
    import com.views.maps.events.URLRequestBufferEvent;
    ...
    [Event(name="URLRequestBufferRequestTimeout",type="com.views.maps.events.URLRequestBufferEvent")]
    [Event(name="URLRequestBufferWaitingRequestAdded",type="com.views.maps.events.URLRequestBufferEvent")]
    [Event(name="URLRequestBufferWaitingRequestRemoved",type="com.views.maps.events.URLRequestBufferEvent")]
    [Event(name="URLRequestBufferActiveRequestAdded",type="com.views.maps.events.URLRequestBufferEvent")]
    [Event(name="URLRequestBufferActiveRequestRemoved",type="com.views.maps.events.URLRequestBufferEvent")]
